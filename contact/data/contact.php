...
// User settings
$to = "benner.dan@gmail.com";
$subject = "Contact from danux.me";
...
<div style='text-align: center; margin-bottom: 10px; color: #434343;'>DAN BENNER</br>
Saint Paul, MN</br> </br>
 
benner.dan@gmail.com</br>
843.504.7221</br> </div>
	...
	//if ($extra["form_cc"]) {
		//$output .= "
		//	<label>&nbsp;</label>
			//<input type='checkbox' id='contact-cc' //name='cc' value='1' tabindex='1005' /> //<span class='contact-cc'> </span>
			//<br/>";
	//}
